define(['ember','modules/handlebars-helpers','moment','modules/bugs','modules/bug','modules/CommentEditorComponent','modules/persona','modules/modals','autoresize'], function(Ember,HandleBarsHelpers,Moment,Bugs,Bug,CommentEditorComponent,Persona,Modals) {
	var App;
