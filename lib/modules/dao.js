define(['jquery','underscore','modules/modals','modules/persona'],function($,_,Modals,Persona){
	...
	/*
	 * Function which will save edits to description of a bug.
	 */
	var saveBugDescription = function(bug,callbacks){
		var obj = {
			bugid:bug.id,
		...
		$.ajax({
			dataType:"json",
			url: 'rest/savebugdescription.php',
			data:obj,
			success: function(response){
				callbacks.successCallBack();
			},
	...
	var saveComment = function(data,callbacks){
		$.ajax({
      		dataType: "json",
      		data: data,
      		url: 'rest/savecomment.php',
      		success: function(data){
	...
	var commentAndClose = function(data,callbacks){
		$.ajax({
      		dataType: "json",
      		data: data,
      		url: 'rest/commentclose.php',
      		success: function(data){
          		callbacks.success(data);
      		},
      		error: function(err,text,exception){
	...
	var commentAndReopen = function(data,callbacks){
		$.ajax({
      		dataType: "json",
      		data: data,
      		url: 'rest/commentreopen.php',
      		success: function(data){
          		callbacks.success(data);
      		},
      		error: function(err,text,exception){
	...
	var deleteComment = function(data,callbacks){
		$.ajax({
      		dataType: "json",
      		data: data,
      		url: 'rest/deletecomment.php',
      		success: function(data){
          		callbacks.success(data);
      		},
      		error: function(err,text,exception){
	...
	return {
		...
		returnBug : returnBug,
		saveBugDescription : saveBugDescription,
		saveComment : saveComment,
		deleteComment: deleteComment,
		commentAndClose : commentAndClose,
		commentAndReopen : commentAndReopen
	};
