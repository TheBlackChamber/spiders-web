		...
		App.BugsRoute = Ember.Route.extend({
		 	model: function(params) {
		 		var model = BugListModel.create({
		      	...
		      	Dao.fetchBugList(model, 'allbugs.php',filter);
		 	...
		 	actions: {
		 		assignment: function(assigned) {
			    	...
			    	var filterfunction = function(){
			    		...
			    		if(assigned == 'mine'){
			    			...
			    			Dao.fetchBugList(model,'mybugs.php',filter);

			    		}else if(assigned == 'unassigned'){

			    			Dao.fetchBugList(model,'unassignedbugs.php',filter);
			    ...
			    removelabelnewbug: function(label){
			  	...
			  	createproject: function(){
			      	...
			      	model.get('projectlist').addObject(project);
